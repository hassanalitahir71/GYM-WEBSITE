              ...
              <div className="grid w-full grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-20">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <h2 className="font-made text-3xl leading-13 text-white sm:text-3xl lg:text-5xl">
                    ...
                    Service For Your Health <br className="hidden sm:block" />
                    And Fitness
                  </h2>

                  {/* Description */}
                  <p className="font-made max-w-lg text-base leading-relaxed text-gray-300 sm:text-sm">
                    At IronForge, fitness isn't casual it's a structured system
                    built on consistency, intensity, and real results. It's
                    about showing up when it's hard, pushing beyond limits, and
                    committing to a process that transforms not just your body,
                    but your mindset, confidence, and lifestyle.
                  </p>
                </div>
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="font-made hover:border-yellow flex flex-col justify-center border-b-4 border-transparent bg-[#222222]/90 p-6 backdrop-blur-sm transition-transform hover:-translate-y-1 hover:border-b-4"
                  >
                    <h3 className="mb-2 text-4xl font-bold text-white sm:text-5xl">
                      15+
                    </h3>
                    <p className="text-lg text-gray-400">Years Experiences</p>
                  </motion.div>

                  {/* Stat Card 2 */}
                  <motion.div
                    variants={cardVariants}
                    className="hover:border-yellow flex flex-col justify-center border-b-4 border-transparent bg-[#222222]/90 p-6 backdrop-blur-sm transition-transform hover:-translate-y-1 hover:border-b-4"
                  >
                    <h3 className="mb-2 text-4xl font-bold text-white sm:text-5xl">
                      4K+
                    </h3>
                    <p className="text-lg text-gray-400">Satisfied Clients</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-lg text-gray-400">Trained Coaches</p>
                  </motion.div>
                </motion.div>
              </div>
            </div>
    ...
    return (
      <>
        <section className="relative flex min-h-screen w-full flex-col overflow-hidden bg-black">
          {/* 1. Background Image Layer */}
          <div
            className="pointer-events-none absolute inset-0 z-0 bg-cover bg-start bg-no-repeat"
            style={{
              backgroundImage: 'url("/img/Membership-bg.jpg")',
            }}
          ></div>
          ...
          <div className="relative z-10 flex min-h-screen w-full flex-col">
            ...
            >
              ...
              <motion.p
                ...
                className="font-made relative z-20 mt-4 max-w-3xl px-4 text-sm leading-relaxed text-gray-300 sm:text-base md:mt-8 md:text-lg"
              >
                Choose a membership crafted for those who demand more offering
                exclusive access to elite training programs, cutting-edge
                equipment, and a results-focused environment built to elevate
                your strength, mindset, and overall performance.
              </motion.p>
            </motion.div>
          </div>
        </section>
